...
//   Bir metod olusturun: dismissAlert  butona tıklayın, uyarıdaki Cancel butonuna tıklayın ve result mesajının successfuly” icermedigini test edin.

//   Bir metod olusturun: sendKeysAlert //. 3 butona tıklayın, uyarıdaki metin kutusuna isminizi yazin, OK butonuna
//   tıklayın ve result mesajında isminizin görüntülendiğini doğrulayın.
    ...
    public void test3() throws InterruptedException {
        ...
        String webdekiMesaj=driver.findElement(By.xpath("//*[@id='result']")).getText();
        String arananMesaj = "hüseyin";
        Assert.assertTrue(webdekiMesaj.contains(arananMesaj));
